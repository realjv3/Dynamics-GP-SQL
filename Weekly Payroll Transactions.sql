...
DECLARE @TRXBEGDT datetime; SET @TRXBEGDT = '01-21-2015'; --MANUALLY SET DATE get pay period begin date from first query
DECLARE @TRXENDDT datetime; SET @TRXENDDT = '01-27-2015'; --MANUALLY SET DATE get pay period end date from first query
...
WHERE a.CHEKDATE >= '02-02-2015'	--from Monday to Sunday MANUALLY SET DATE 
AND a.CHEKDATE < '02-08-2015'
