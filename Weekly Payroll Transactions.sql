...
DECLARE @TRXBEGDT date; SET @TRXBEGDT = '03-18-2015'; --MANUALLY SET DATE get pay period begin date from first query
DECLARE @TRXENDDT date; SET @TRXENDDT = '03-24-2015'; --MANUALLY SET DATE get pay period end date from first query
...
WHERE a.CHEKDATE >= '03-30-2015'	--from Monday to Sunday MANUALLY SET DATE 
AND a.CHEKDATE < '04-05-2015'
