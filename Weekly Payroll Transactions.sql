...
DECLARE @TRXBEGDT datetime; SET @TRXBEGDT = '01-14-2015'; --MANUALLY SET DATE get pay period begin date from first query
DECLARE @TRXENDDT datetime; SET @TRXENDDT = '01-20-2015'; --MANUALLY SET DATE get pay period end date from first query
...
WHERE a.CHEKDATE >= '01-26-2015'	--from Monday to Sunday MANUALLY SET DATE 
AND a.CHEKDATE < '02-01-2015'
