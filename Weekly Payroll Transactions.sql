...
DECLARE @TRXBEGDT date; SET @TRXBEGDT = '02-18-2015'; --MANUALLY SET DATE get pay period begin date from first query
DECLARE @TRXENDDT date; SET @TRXENDDT = '02-24-2015'; --MANUALLY SET DATE get pay period end date from first query
...
WHERE a.CHEKDATE >= '03-02-2015'	--from Monday to Sunday MANUALLY SET DATE 
AND a.CHEKDATE < '03-08-2015'
