...
DECLARE @TRXBEGDT date; SET @TRXBEGDT = '03-09-2015'; --MANUALLY SET DATE get pay period begin date from first query
DECLARE @TRXENDDT date; SET @TRXENDDT = '03-15-2015'; --MANUALLY SET DATE get pay period end date from first query
...
WHERE a.CHEKDATE >= '03-16-2015'	--from Monday to Sunday MANUALLY SET DATE 
AND a.CHEKDATE < '03-22-2015'
